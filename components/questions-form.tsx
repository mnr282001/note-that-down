...
import { CalendarDays, CheckCircle, Clock, File, HelpCircle, Send, ThumbsUp } from 'lucide-react'
...
export default function QuestionsForm() {
  ...
  if (submitted) {
    return (
      <FormLayout title="Daily Standup Notes" showSuggestionsLink session={session}>
